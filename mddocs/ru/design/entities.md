...
Each namespace has an owner which can alter namespace properties, see [Role Permissions](permissions.md#role-permissions).
...
User can have different roles in different namespaces. See [Role Permissions](permissions.md#role-permissions).
